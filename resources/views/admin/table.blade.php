              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <img src="{{ asset('images/' . $p->gambar) }}" alt="Produk" class="img-thumbnail">
                    </td>
                    <td>{{ $p->nama_produk }}</td>
                    <td>{{ $p->kategori }}</td>
                    ...
                    <a href="{{ route('admin.edit', $p->id) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('admin.destroy', $p->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
