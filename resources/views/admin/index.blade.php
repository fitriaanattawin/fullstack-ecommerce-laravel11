...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ asset('adminn/plugins/summernote/summernote-bs4.min.css') }}">
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="adminn/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="adminn/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="adminn/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user1-128x128.jpg" alt="User Avatar') }}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user7-128x128.jpg" alt="User Avatar') }}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user3-128x128.jpg" alt="User Avatar') }}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user5-128x128.jpg" alt="User Avatar') }}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user6-128x128.jpg" alt="User Avatar') }}">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ asset('adminn/dist/img/user8-128x128.jpg" alt="User Avatar') }}">
...
<!-- jQuery UI 1.11.4 -->
<script src="adminn/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- ChartJS -->
<script src="{{ asset('adminn/plugins/chart.js/Chart.min.js') }}"></script>
<!-- Sparkline -->
<script src="{{ asset('adminn/plugins/sparklines/sparkline.js') }}"></script>
<!-- JQVMap -->
<script src="{{ asset('adminn/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('adminn/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('adminn/plugins/jquery-knob/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
