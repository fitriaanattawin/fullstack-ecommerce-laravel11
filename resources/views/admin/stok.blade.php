      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="stok" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Stok Barang</h1><br>
            <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalTambahStok">
              ...
              <form action="{{ route('stok.store') }}" method="POST">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Tambah Stok Barang Lama</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <select name="product_id" class="form-select" required>
                        <option selected disabled>-- Pilih Produk Lama --</option>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Mutasi Tables</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
