        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <input class="form-control" type="text" name="name" 
                    value="{{ old('name', $user->name ?? '') }}" readonly> {{-- Ambil nama dari user yang login --}}
            </div>
            <div class="col-md-6 form-group">
                <label>Address</label>
                <input class="form-control" type="text" name="alamat" 
                    value="{{ old('alamat') }}" placeholder="Enter your address" required>
            </div>
            <div class="col-md-6 form-group">
                <label>E-mail</label>
            ...
            <div class="col-md-6 form-group">
                ...
                <input class="form-control" type="text" name="no_hp" 
                    value="{{ old('no_hp') }}" placeholder="Enter your number" required>
            </div>
            <div class="col-md-6 form-group">
                <label>Total</label>
                <input class="form-control" type="number" name="total" 
                    value="{{ $total ?? 0 }}" readonly> {{-- Ambil total dari cart atau variabel --}}
            </div>
...
<div class="form-group" id="bukti-section">
    ...
    <div class="row px-xl-5">
        <div class="col-lg-12">
                ...
                <!-- Header -->
                <div class="d-flex font-weight-bold border-bottom pb-2 mb-3">
                    <div style="width: 80px;">Picture</div>
                    <div class="flex-grow-1">Product Name</div>
                    <div style="width: 60px;" class="text-center">Qty</div>
                    <div style="width: 100px;" class="text-center">Price</div>
                </div>
                ...
                @foreach ($cartItems as $item)
                    @php
                        $itemSubtotal = $item->product->harga * $item->quantity;
                ...
                <div class="pt-3">
                    <div class="d-flex justify-content-end mb-2">
                        <div style="width: 220px;" class="d-flex justify-content-between">
                            <span>Subtotal Qty</span>
                            <strong>{{ $totalQty }} product</strong>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end mb-2">
                        <div style="width: 220px;" class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-end border-top pt-2 mt-2">
                        <div style="width: 220px;" class="d-flex justify-content-between">
                            <span>Total</span>
                            <strong>Rp {{ number_format($subtotal + $shipping, 0, ',', '.') }}</strong>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- <form action="{{ route('checkout.proses') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="bukti_pembayaran" id="paypal" value="paypal" required>
                    <label class="form-check-label" for="paypal">Paypal</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" name="bukti_pembayaran" id="directcheck" value="directcheck" required>
                    <label class="form-check-label" for="directcheck">Direct Check</label>
                </div>
                <div class="form-check mb-3">
                    <input type="radio" class="form-check-input" name="bukti_pembayaran" id="banktransfer" value="banktransfer" required>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="detailbarang"><i class="fa fa-angle-right mr-2"></i>Shop Detail</a>
