            ...
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <img src="{{ asset('images/' . $product->gambar) }}" alt="{{ $product->nama }}" class="img-square">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">(56 Reviews)</small>
                    </div>
                   <h3>Rp {{ number_format($product->harga, 0, ',', '.') }}</h3>
                    <p>{{ $product->deskripsi }}</p>
                               <h6>stock product: {{ $product->stok }}</h6>
                    <form action="{{ url('cart/add') }}" method="POST" onsubmit="return syncQty()">
                            @csrf
                        <div class="input-group mr-3" style="width: 130px;">
                            <div class="input-group-prepend">
                                <button type="button" class="btn btn-warning btn-minus" onclick="updateQty(-1)">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </div>
                            <input type="text" name="quantity" id="quantityInput" class="form-control text-center" value="1" readonly>
                            <div class="input-group-append">
                                <button type="button" class="btn btn-warning btn-plus" onclick="updateQty(1)">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src="{{ asset('img/namtan.jpeg') }}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>Phii Namtan<small> - <i>21 June 2025</i></small></h6>
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="detailbarang"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="shop"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a>
